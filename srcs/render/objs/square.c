...
/*   Updated: 2020/05/11 15:54:16 by pguthaus         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "world.h"

static t_bool		beetween_points(t_square square, t_vec3f origin,
	...
	float *dist)
{
	...
	does_intersect = square_intersects(square, next_ray->origin,
